...
rootCommand.SetHandler(Application.ExecutePuzzles, yearOption, dayOption, iterationsOption);
...
public static class Application
{
   ...
   public static void ExecutePuzzles(int selectedYear, int? selectedDay, int iterations)
    {
    ...
    static string Run(PuzzleContainer puzzle, string part, string input, Func<IPuzzle, string, object> func,
    ...
    static string ResourceString(PuzzleContainer puzzle)
    {
        ...
        using Stream? manifestResourceStream =
            assembly.GetManifestResourceStream($"AdventOfCode.Input.Year{puzzle.Year:0000}.Day{puzzle.Day:00}.txt");
